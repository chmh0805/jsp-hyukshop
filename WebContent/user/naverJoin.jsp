...
<%
	if (request.getAttribute("naverId") == null) { // userType이 없으면 로그인상태 아님!!
...
<article class="card-body" style="max-width: 700px; margin: auto;">
    ...
    <!-- 회원가입 form태그 시작 -->
	<form method="post" action="user?cmd=naverJoin">
    ...
    <div class="form-group input-group fg-x700">
    	...
    	<input name="phone" class="form-control" placeholder="휴대폰번호 입력('-' 포함)" value="${phone}" type="text" required />
    </div> <!-- form-group// -->
    <div class="form-group input-group fg-x700">
    	<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-building"></i> </span>
		</div>
		<input name="address" id="Addr" class="form-control" placeholder="주소 입력" type="text" readonly required onkeypress="return false;" style="caret-color: transparent !important;" />
    ...
    <div class="fg-x700 form-group">
        <button type="submit" class="btn btn-primary btn-block"> 네이버로 회원가입 </button>
    </div> <!-- form-group// -->      
</form>
</article>
</div> <!-- card.// -->
