			...
			<c:choose>
				<c:when test="${sessionScope.principal != null}">
					<div id="header-main-menu">
						...
						<a href="<%=request.getContextPath()%>/user?cmd=favor"
							class="header-sub-menu">찜</a> <a href="#" class="header-sub-menu">장바구니</a>
						<a href="<%=request.getContextPath()%>/user?cmd=checkAgain"
							class="header-sub-menu">마이페이지</a> <a
				...
				<c:choose>
					<c:when test="${pageContext.request.requestURI eq '/shop/rank/' }">
						<button type="button" id="header-sec-rank" style=""
							class="btn btn-basic header-second-btn-group border-btm-red">랭킹</button>
					</c:when>
					<c:otherwise>
						<button type="button" id="header-sec-rank" style=""
							class="btn btn-basic header-second-btn-group">랭킹</button>
					</c:otherwise>
				</c:choose>
				<div class="btn-group">
